...
public class GenEntityOracle {
    ...
    private String packageOutPath = "main.java.com.bw.entity";// 指定实体生成所在包的路径
...
//    private static final String PASS = "tiger";
    private static final String URL="jdbc:mysql://localhost:3306/ssm?user=root&password=root&useUnicode=true&characterEncoding=UTF8";
...
//            return "Date";
    ...
    public static void main(String[] args) {  
        ...
        new GenEntityOracle("brand","Brand","ssm").init();
        new GenEntityOracle("goods","Goods","ssm").init();
        new GenEntityOracle("goodskind","Goodkind","ssm").init();
    }  
}